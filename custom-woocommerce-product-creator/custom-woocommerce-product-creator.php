...
// Give a notice to user if woocommerce is not installed and activated
...
// Admin init
add_action("admin_init", "wcp_handle_add_product_from_submit");
function wcp_handle_add_product_from_submit()
{
