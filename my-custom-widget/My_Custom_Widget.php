...
?>
        ...
        <p>
            ...
            <select class="widefat mcw_dd_options" name="<?php echo $this->get_field_name('mcw_display_option') ?>" id="<?php echo $this->get_field_id('mcw_display_option') ?>">
                <option <?php if ($mcw_display_option == "recent_posts") {
                            echo "selected";
                        } ?> value="recent_posts">Recent Posts</option>
                <option <?php if ($mcw_display_option == "static_message") {
                            echo "selected";
                        } ?> value="static_message">Static Message</option>
            </select>
        </p>
        <p id="mcw_display_recent_posts" <?php if ($mcw_display_option == "recent_posts") {
                                            } else {
        ...
        <p id="mcw_display_static_message" <?php if ($mcw_display_option == "static_message") {
                                            } else {
                                                echo 'class="hide_element"';
                                            }  ?>>
...
<?php
    ...
    public function widget($args, $instance)
    {
        ...
        } else if($instance['mcw_display_option'] == "recent_posts") {
